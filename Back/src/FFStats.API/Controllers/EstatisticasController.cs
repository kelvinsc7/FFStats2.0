...
namespace FFStats.API.Controllers
{
    ...
    public class EstatisticasController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Post(Estatisticas model)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, Estatisticas model)
        {
            try
            {
        ...
        public async Task<IActionResult> Delete(int Id)
        {
            try
            {
                return await _EstatisticasService.DeleteEstatisticas(Id) ?
                        Ok("Deletado"):
                        BadRequest("Estatisticas Não Deletada");
            }
            catch (Exception ex)
            {
